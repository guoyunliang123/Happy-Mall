...
class ProductSave extends React.Component {
  ...
  // 品类选择器的变化
  onCreatoryChange(categoryId, parentCategoryId) {
    this.setState({
        ...
        <div className="form-horizontal">
            ...
            <CategorySelect
              onCreatoryChange={
                (categoryId, parentCategoryId) => {
                  this.onCreatoryChange(categoryId, parentCategoryId);
                }
              }
          ...
          <div className="form-group">
            ...
            <div className="col-md-offset-2 col-md-10 file-upload-con">
              <FileUploader
                onSuccess={
                  (res) => {this.onUploadSuccess(res)}
                }
                onError={
                  (errMsg) => {this.onUploadError(errMsg)}
                }
              />
            </div>
          </div>
